export const homeContent = {
  profile: {
    name: "Dr. Santosh Kumar S",
    title: "BDS, MBA, FIII.",
    location: "Chennai, Tamil Nadu, India",
    avatarLetters: "DS",
    profileImagePath: "/santosh.png",
    tags: ["Health Insurance", "Healthcare Management", "Dentistry", "Fraud Mitigation"],
  },
  summary: {
    ...
    achievements: [
      {
        id: "achieve-fraud",
        text: "At <strong>Cholamandalam MS General Insurance</strong>, implemented AI-based fraud detection system that reduced fraudulent claims by 28% and saved approximately ₹3.4 crore ($410,000 USD / £325,000) annually.",
      },
      {
        id: "achieve-network",
        text: "Led network expansion at <strong>Star Health and Allied Insurance</strong>, onboarding 3000+ hospitals across South India, improving claim settlement time by 35%.",
      },
      {
        id: "achieve-workflow",
        text: "Developed Automated new claims processing workflow at <strong>Star Health</strong>, reducing approval turnaround time from 4 hours to 190 milliseconds while maintaining 99.2% accuracy.",
      },
      {
        id: "achieve-pricing",
        text: "Developed and implemented healthcare pricing strategy at <strong>Star Health</strong> that optimized reimbursement rates and reduced payment disputes by 40%.",
      },
    ],
  },
  contact: {
