export const businessContent = {
  ...
  leadershipApproach: {
    ...
    tags: [
      { id: "lead-dev", label: "Team Development" },
      { id: "lead-mentor", label: "Mentorship" },
      { id: "lead-collab", label: "Cross-functional Collaboration" },
      { id: "lead-decision", label: "Strategic Decision Making" }
    ]
  },
  professionalExperience: {
    ...
    experiences: [
      ...
      {
        id: "exp-star",
        company: "Star Health and Allied Insurance Co. Ltd (3 years 11 months)",
  ...
  education: {
    ...
    credentials: [
      ...
      {
        id: "edu-iii",
        institution: "Insurance Institute of India",
