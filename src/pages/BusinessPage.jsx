      ...
      <Box sx={{ my: 4 }}>
        ...
        <Grid container spacing={4}>
          ...
          <Grid item xs={12} md={4}>
            <Box sx={{ position: 'sticky', top: '80px' }}> {/* Sticky container */} 
                ...
                <Grid container spacing={3}>
                   {businessContent.education.credentials.map((cred, index) => (
                    <Grid item xs={12} md={6} key={cred.id}>
                      {/* Adjusted bottom margin logic for the last row */}
                      <Paper elevation={0} sx={{...innerPaperStyle, height: '100%', mb: (index >= businessContent.education.credentials.length - 2) ? 0 : { xs: 3, md: 0 } }}> 
                         <Typography variant="h6" component="h3">
                           {cred.institution}
                        </Typography>
